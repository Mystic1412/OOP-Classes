public class Lab16Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Here is myList1: " + myList1);
		System.out.println("Here is myList2: " + myList2);
		System.out.println("myList1 equal myList2: " + myList1.equals(myList2));  //return true
		...
		for (int i = 0; i < dataSource.length; i++) {
			...
			myList5.prepend(dataSource[i]); //prepend is adding node in the front
			myList6.append(dataSource[i]); //adding at the end
